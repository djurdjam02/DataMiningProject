...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.2\textwidth]{images/epochs_aa.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.2\textwidth]{images/epochs_pb.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.2\textwidth]{images/epochs_ss.png}
